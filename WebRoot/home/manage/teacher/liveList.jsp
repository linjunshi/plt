			...
			<div id="container_content">
			    <div class="sectionMain clr">
					...
					<div class="sh_info_r">
						...
						<div class="sh_myvod_ti"><span>时间</span><span class="sh_ti_sid">直播名称</span><span class="sh_ti_course">所属课程</span><span>操作</span></div>
				            <div class="sh_myvod">
				                <ul>
				                    ...
				                    <li>
				                        ...
				                        <div class="sh_myvod_ri clr"> 
				                        	<p class="sh_myvod_img"><img src="${ctx}/resource/images/007.jpg"></p>
				                            <h2>${live.title}</h2>
				                            <p class="sh_myvod_name">${live.courseName}<br/>${live.remark}</p>
				                            <p><span><a href="javascript:void(0);" class="open_tool" id="i_${live.id}">进入</a></span></p>
				                        </div>
				                    </li>
				                    </c:forEach>
				                </ul>
