	...
	<div id="demo_zone">
		...
		<form method="post" action="${ctx}/manage/course/addResourceLive" class="form_info common_form" id="live_form">
			...
			<div class="form_item">
				...
				<div class="form_field">
					<input placeholder="格式：2014-01-01 59:59" class="form_text" name="beginTime" id="beginTime" type="text" value="<fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm" value="${live.beginTime}" />" required required_DateTime>
					<span class="not-empty" title='此项为必填项'>*</span>
				</div>
			</div>
			<div class="form_item">
