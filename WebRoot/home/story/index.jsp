		...
		<div class="zhe_home">
			<ul>
				<li>
					...
					<p>
						<a href="${ctx}/story/game/ProudCock?demo=0" class="zhe_but_c" title="美丽的公鸡">&nbsp;</a>
						<a href="${ctx}/story/game/ProudCock?demo=1" class="zhe_but_b" title="美丽的公鸡">&nbsp;</a>
					</p>
				</li>
				<li>
					<p class="zhe_photo">
					...
					<p>
						<a href="${ctx}/story/game/KongFuA?demo=0" class="zhe_but_c" title="功夫片段A">&nbsp;</a>
						<a href="${ctx}/story/game/KongFuA?demo=1" class="zhe_but_b" title="功夫片段A">&nbsp;</a>
					</p>
				</li>
				<li>
					<p class="zhe_photo">
					...
					<p>
						<a href="${ctx}/story/game/KongFuB?demo=0" class="zhe_but_c" title="功夫片段B">&nbsp;</a>
						<a href="${ctx}/story/game/KongFuB?demo=1" class="zhe_but_b" title="功夫片段B">&nbsp;</a>
					</p>
				</li>
				<li>
					<p class="zhe_photo">
					...
					<p>
						<a href="${ctx}/story/game/RangZiDanFeiA?demo=0" class="zhe_but_c" title="让子弹飞片段A">&nbsp;</a>
						<a href="${ctx}/story/game/RangZiDanFeiA?demo=1" class="zhe_but_b" title="让子弹飞片段A">&nbsp;</a>
					</p>
				</li>
				<li>
					<p class="zhe_photo">
					...
					<p>
						<a href="${ctx}/story/game/RangZiDanFeiA?demo=0" class="zhe_but_c" title="让子弹飞片段B">&nbsp;</a>
						<a href="${ctx}/story/game/RangZiDanFeiA?demo=1" class="zhe_but_b" title="让子弹飞片段B">&nbsp;</a>
					</p>
				</li>
				<li>
					<p class="zhe_photo">
					...
					<p>
						<a href="${ctx}/story/direction" class="zhe_but_a">&nbsp;</a>
					</p>
				</li>
			</ul>
		</div>
