...
<body>
	...
	<div id="container_box">
		<div id="container_content">
			<div class="form_questions trainDiv clr">
				<div class="train_main">
					...
					<div class="form_action">
						<a class="btn_question preOne" style="visibility: hidden"
							href="javascript:void(0);">上一题</a> <a class="btn_question nextOne"
							<c:if test="${total <= 1}">style="visibility:hidden"</c:if>
							href="javascript:void(0);">下一题</a>
					</div>
				</div>

				<form action="${ctx}/train/question" method="post" class="train_form">
