...
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/zTreeStyle.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/boxy.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/new.css" />
...
<script type="text/javascript" src="${ctx}/resource/js/ztree/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/ztree/jquery.ztree.excheck-3.5.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/ztree/jquery.ztree.exedit-3.5.js"></script>
